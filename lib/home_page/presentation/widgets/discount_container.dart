...
import '../../../detail_page/home/presentation/pages/home_view_model.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
             context.goNamed("/batafsil", extra: PackageDetailViewModel(repo: PackageRepository(client: ApiClient())));
            },
            child: Text("Batafsil...",
                style: TextStyle(
